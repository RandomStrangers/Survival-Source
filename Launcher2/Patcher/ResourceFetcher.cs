...
namespace Launcher.Patcher {
	...
	public sealed class ResourceFetcher {
		...
		const string digSoundsUri = "https://s3.amazonaws.com/MinecraftResources/sound3/dig/";
		const string altDigSoundsUri = "https://s3.amazonaws.com/MinecraftResources/sound3/random/";
		const string stepSoundsUri = "https://s3.amazonaws.com/MinecraftResources/newsound/step/";
		const string altStepSoundsUri = "https://s3.amazonaws.com/MinecraftResources/sound3/step/";
		const string musicUri = "https://s3.amazonaws.com/MinecraftResources/music/";
		const string newMusicUri = "https://s3.amazonaws.com/MinecraftResources/newmusic/";
