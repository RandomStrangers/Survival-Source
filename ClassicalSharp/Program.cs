...
namespace ClassicalSharp {
	...
	internal static class Program {
		...
		public const string AppName = "ClassiCube 1.3.5";
		...
		static void Main(string[] args) {
			...
			if (args.Length == 0 || args.Length == 1) {
				const string skinServer = "http://cdn.classicube.net/skin/";
		...
		static void RunMultiplayer(string[] args, bool nullContext, int width, int height) {
			...
			string skinServer = args.Length >= 5 ? args[4] : "http://cdn.classicube.net/skin/";
